import { j as e, a as o, d as r } from "./app-CdPiUioM.js";
function n({ auth: s, laravelVersion: t, phpVersion: a }) {
    return e.jsxs(e.Fragment, {
        children: [
            e.jsx(o, { title: "Welcome" }),
            e.jsxs("div", {
                className:
                ...
                children: [
                    e.jsx("div", {
                        className: "sm:fixed sm:top-0 sm:right-0 p-6 text-end",
                        children: s.user
                            ? e.jsx(r, {
                            ...
                            : e.jsxs(e.Fragment, {
                                  children: [
                                      ...
                                      e.jsx(r, {
                                          href: route("register"),
                                          className:
                                              "ms-4 font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500",
                                          children: "Register",
                                      }),
                                  ],
                              }),
                        ...
                        children: [
                                            ...
                                            children: [
                                                e.jsxs("div", {
                                                    children: [
                                                        ...
                                                        e.jsx("p", {
                                                            className:
                                                                "mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed",
                                                            children:
                            ...
                            e.jsxs("div", {
                                ...
                                children: [
                                    e.jsx("div", {
                                        className:
                                            "text-center text-sm text-gray-500 dark:text-gray-400 sm:text-start",
                                        children: e.jsx("div", {
                                            className:
                                            ...
                                            children: e.jsxs("a", {
                                                ...
                                                children: [
                                                    e.jsx("svg", {
                                                        ...
                                                        strokeWidth: "1.5",
                                                        className:
                                                            "-mt-px me-1 w-5 h-5 stroke-gray-400 dark:stroke-gray-600 group-hover:stroke-gray-600 dark:group-hover:stroke-gray-400",
                                                        children: e.jsx(
                                                            "path",
                                                            {
                                                                strokeLinecap:
                                    ...
                                    e.jsxs("div", {
                                        className:
                                            "ms-4 text-center text-sm text-gray-500 dark:text-gray-400 sm:text-end sm:ms-0",
                                        children: [
                                            "Laravel v",
                                            t,
                                            " (PHP v",
